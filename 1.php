...
$product_name = "Coraline";

$sql = "SELECT product_id, author, product_price FROM products WHERE product_name = '$product_name'";
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="login.php" id="logout-link"><i class="fa fa-unlock"></i> Logout</a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p>Web ID: <?php echo $product_id; ?></p>
								
								<span>
									<span><?php echo $product_price;?> CUBES</span>
									<style type="text/css">
										a {
										color: white;
										}
									</style>
	<a href="deduct_tokens.php?product_id=<?php echo $product_id ?>">
...
<script>
    document.getElementById('buy').addEventListener('click', function() {
        ...
        xhr.open('POST', 'deduct_tokens.php', true);
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                if (response === "Tokens deducted successfully") {
                    location.reload();
                }
            }
        };
        xhr.send();
								...
								<p><b>Category:</b>  Mystery , Kids , Fiction</p>
